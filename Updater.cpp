...
{
    Updater::Updater(asio::io_service & ioService, tls::Configuration * tlsConfiguration) : 
        mListeningSocket(ioService, asio::ip::tcp::endpoint(asio::ip::tcp::v4(), 60000)),
        mStreamSocket(ioService),
        mIo(&mStreamSocket)
    {
